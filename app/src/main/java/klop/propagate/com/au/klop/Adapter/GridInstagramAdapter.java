...
import klop.propagate.com.au.klop.Model.ImageLoader;
import klop.propagate.com.au.klop.R;

/**
 * Created by trung on 22/12/2016.
 */
public class GridInstagramAdapter extends BaseAdapter {
    // private Context context;
    private ArrayList<String> imageThumbList;
    private LayoutInflater inflater;
    private ImageLoader imageLoader;

    public GridInstagramAdapter(Context context, ArrayList<String> imageThumbList) {
